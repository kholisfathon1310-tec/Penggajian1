...
// AMBIL POSISI USER
// ======================
$stmtPosisi = $conn->prepare("SELECT hak FROM user WHERE NIP = :nip");
$stmtPosisi->execute([':nip' => $nip]);
        ...
        if ($validationResult === true) {
            ...
            if (move_uploaded_file($_FILES['image']['tmp_name'], $imagePath)) {
                ...
                $stmt = $conn->prepare("
                    ...
                    (NIP, nama_user, posisi, jam_masuk, image, lembur)
                    VALUES 
                    (:nip, :nama_user, :posisi, NOW(), :image, 'tidak')
                ");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['lembur'])) {
    ...
    if (isset($_FILES['lembur_image']) && $_FILES['lembur_image']['error'] === 0) {
        ...
        if ($validationResult === true) {
            ...
            if (move_uploaded_file($_FILES['lembur_image']['tmp_name'], $lemburImagePath)) {
                ...
                $message = "Gagal upload foto lembur.";
            }
        ...
        $message = "Silakan upload foto lembur.";
    }
}
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label class="form-label">
                                Unggah Foto Sedang bekerja dikantor
                            </label>
